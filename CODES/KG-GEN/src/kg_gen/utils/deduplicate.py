...
def run_semhash_deduplication(
    ...
    for relation in graph.relations:
        transformed = _get_relation(relation)
        dedup_triplet = tuple(transformed)
        relation_clusters.setdefault(dedup_triplet, set()).add(tuple(relation))
        new_relations.append(transformed)
