...
class KGGen:
    ...
    def generate(
        ...
        def _process(content, lm, relation_hints=None, entity_hints=None):
        ...
        if not chunk_size:
            try:
                entities, relations = _process(processed_input, self.lm, relation_hints, entity_hints)
        ...
        if chunk_size:
            ...
            with ThreadPoolExecutor() as executor:
                future_to_chunk = {
                    executor.submit(_process, chunk, self.lm, relation_hints, entity_hints): chunk for chunk in chunks
                }
